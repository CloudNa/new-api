...
func TestFormatUserLogsStripsProfitFields(t *testing.T) {
	...
	require.NotContains(t, other, "output_policy_requested_max_tokens")
	require.NotContains(t, other, "output_policy_applied_max_tokens")
