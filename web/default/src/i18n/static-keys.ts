...
export const STATIC_I18N_KEYS = [
  ...
  'Model modes JSON',
  'Channel modes JSON',
  'RTK raw output max bytes',
  'RTK max lines',
  'RTK max chars',
  'RTK deduplicate threshold',
  'RTK enabled filters',
  'RTK disabled filters',
  'Caveman language',
  'Caveman roles',
  'Caveman skip rules',
  'Caveman preserve patterns',
  'Caveman enabled language packs',
  'Caveman minimum message length',
  'Aggressive full summary threshold',
  'Aggressive moderate threshold',
  'Aggressive light threshold',
  'Aggressive verbatim threshold',
  'Aggressive max tokens per message',
  'Aggressive minimum savings threshold',
  'Ultra compression rate',
  'Ultra minimum score threshold',
  'Ultra max tokens per message',
  'Ultra model path',
  'Stacked pipeline JSON',
